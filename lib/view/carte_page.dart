                      ...
                      return Padding(
                        ...
                        child: Dismissible(
                          ...
                          onDismissed: (direction) {
                            // setState(() {});
                            print(carteController.orederList.values
                                .elementAt(index)
                                .id);
                            contx.deleteFromCarte(
                                contx.orederList.values.elementAt(index).id,
                                contx.orederList.values.elementAt(index));
                              ...
                              children: [
                                ...
                                IconButton(
                                  onPressed: () {
                                    ...
                                    // setState(() {});
                                    // carteController.deleteFromCarte();
                                    print("dede");
                                    print(carteController.orederList.values
                                        .elementAt(index)
                                        .id);
                              ...
                              children: [
                                ...
                                IconButton(
                                    onPressed: () {
                                      ...
                                      contx.deleteFromCarte(
                                          contx.orederList.values
                                              .elementAt(index)
                                              .id,
                                          contx.orederList.values
                                              .elementAt(index));
                                      print(contx.orederList.values
                                          .elementAt(index)
                                          .id);
                                    },
                                    icon: const Icon(
                  ...
                  child: SafeArea(
                    child: Column(
                      ...
                      children: [
                        Padding(
                          padding:
                              EdgeInsets.only(bottom: screenHeight / 85.37),
