...
class CheckOut extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: checkOutController.isCompleted
            ? CheckCart()
            : Theme(
                ...
                child: Stepper(
                  ...
                  onStepContinue: () {
                    final isLastStep = checkOutController.currentStep ==
                        checkOutController.getSteps().length - 1;
                    if (isLastStep) {
                  ...
                  onStepCancel: checkOutController.currentStep == 0
                      ? null
                      : () {
                          // setState(() => currentStep -= 1);
                          checkOutController.currentStep -= 1;
